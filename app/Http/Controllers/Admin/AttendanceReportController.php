...
class AttendanceReportController extends Controller
{
    public function index()
    {
        ...
        return view('admin.report.attendance_report.index', compact('classes', 'exams'));
    }
    ...
    public function studentAttendanceReport(Request $request)
    {
        ...
        $students = StudentAdmission::where('class', $request->class_id)->where('section', $request->section_id)->get();
    ...
    {
        $examAttendances = ExamAttendance::with(['student', 'subject'])->where('year', $request->year)->where('exam_id', $request->exam_id)
