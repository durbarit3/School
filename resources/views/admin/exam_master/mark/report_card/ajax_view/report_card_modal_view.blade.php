<div class="print_area">
    <div style="display:none;" class="report_print_header_area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div style="margin-bottom:50px;" class="school_info_area text-right">
                                <h6 style="padding:0px!important;margin:0px!important;color:black!important;">ZYX High School</h6>
                                <h6 style="padding:0px!important;margin:0px!important">Mirpur 1, Dhaka, Bangladesh</h6>
                                <h6 style="padding:0px!important;margin:0px!important">Email : xyzhighschool@gmail.com</h6>
                                <h6 style="padding:0px!important;margin:0px!important">Website : www.xyzhighschool.com</h6>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div style="display:none;" class="print_footer_area">
