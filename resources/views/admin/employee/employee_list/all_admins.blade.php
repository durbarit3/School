                ...
                <div class="row">
                    <div class="col-md-12 mt-1">
                        <div class="employee_list_top_menu">
                            <ul>
                                <li><a class="menu_active" href="{{ route('admin.employee.all.admins') }}"><i class="fas fa-user-friends"></i> Admin</a> </li>
