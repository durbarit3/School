                    ...
                    <div class="col-md-12 mt-1">
                        <div class="employee_list_top_menu">
                            <ul>
                                ...
                                <li><a class="menu_active" href="{{ route('admin.employee.all.super.admins') }}"><i class="fas fa-user-friends"></i> Super Admin</a> </li>
                ...
                <div class="table-responsive">
                    <table id="dataTableExample1" class="table table-bordered table-hover mb-2">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td>{{ $superAdmin['employee_id'] }}</td>
                                <td>{{ $superAdmin['name'] }}</td>
                                <td><img loading="lazy" height="50" width="50"
                                        src="{{ asset('public/uploads/employee/'.$superAdmin['avater']) }}" alt=""></td>
                                <td>{{ $superAdmin['designation'] }}</td>
                                <td>{{ $superAdmin['department']['name'] }}</td>
                                <td>{{ $superAdmin['email'] }}</td>
                                <td>{{ $superAdmin['phone'] }}</td>
                                @if($superAdmin['employee_status'] == 1)
                                ...
                                <td>
                                    @if($superAdmin['employee_status']==1)
                                    <a href="{{ route('admin.employee.status.update', $superAdmin['id'] ) }}"
                                    ...
                                    @endif
                                    | <a href="{{ route('admin.employee.edit', $superAdmin['id']) }}"
                                        class="btn btn-sm btn-blue text-white"><i class="fas fa-pencil-alt"></i></a> |
                                    <a id="delete" href="{{ route('admin.employee.delete', $superAdmin['id']) }}"
