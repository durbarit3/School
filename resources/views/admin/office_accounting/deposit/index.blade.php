            ...
            <div class="panel_header">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <div class="panel_title">
                            @if (json_decode($userPermits->office_accounts_module, true)['deposit']['add'])
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Bank Deposit Entire</h4>
                ...
                <form id="deposit_add_form" class="form-horizontal" action="{{ route('admin.office.account.deposit.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control invoice_no form-control-sm" value="BD{{ $invoiceId }}" name="invoice_no" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" placeholder="Deposit amount" class="form-control amount form-control-sm" value="" name="amount" required>
                        </div>
                    </div>
