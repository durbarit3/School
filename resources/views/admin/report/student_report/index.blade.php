                                    ...
                                    <div class="col-md-4">
                                        <ul class="report_menu_ul">
                                            <li class="report_menu_list">
                                                <a data-value="student_report" class="report_menu_link student_report" href="#"><i class="fas fa-info-circle"></i> 
                                                    <b>Student Report</b> </a>
                                            </li>

                                            <li class="report_menu_list">
                                                <a data-value="sibling_report" class="report_menu_link sibling_report" href="#"><i class="fas fa-info-circle"></i> <b>Sibling Report</b> </a>
                                            </li>
                                            
                                            <li class="report_menu_list">
                                                <a class="report_menu_link guardian_report" data-value="guardian_report"  href="#"><i class="fas fa-info-circle"></i> <b>Guardian Report</b></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="report_menu_ul">
                                            <li class="report_menu_list">
                                                <a data-value="admission_report" class="report_menu_link admission_report" href="#"><i class="fas fa-info-circle"></i> <b>Admission Report</b> </a>
                                            </li>
                                            <li class="report_menu_list">
                                                <a data-value="class_subject_report" class="report_menu_link class_subject_report" href="#"><i class="fas fa-info-circle"></i> <b>Class subject Report</b> </a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <form class="report_form student_report_form" action="{{ route('admin.reports.student.report') }}"
                                ...
                                <div class="heading_area">
                                    <div class="heading">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6><b>Student report form</b><hr class="m-0 p-0"></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form class="report_form sibling_report_form" action="{{ route('admin.reports.student.report.sibling') }}"
                                ...
                                <div class="heading_area">
                                    <div class="heading">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6><b>Sibling report form</b><hr class="m-0 p-0"></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form class="report_form class_subject_report_form" action="{{ route('admin.reports.student.report.class.subject') }}"
                                ...
                                <div class="heading_area">
                                    <div class="heading">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 ><b>Class subject report form</b>
                                                    <hr class="m-0 p-0"></h6>
                                            </div>
                                        </div>
                                    </div>
