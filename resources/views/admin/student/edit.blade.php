	...
	<section class="page_area">
		<form action="{{route('student.update',$data->id)}}" method="POST" enctype="multipart/form-data">
				...
				<div class="panel_body">
					...
					<div class="form-group row">
						<div class="col-sm-3 {{$errors->has('admission_no')? ' has-error':''}}">
							...
							<input type="text" class="form-control" name="admission_no" value="{{$data->admission_no}}"
								required>
						...
						<div class="col-sm-3">
							<label for="inputEmail3" class="text-center">Roll Number<span
									style="color:red">*</span></label>
							<input type="text" class="form-control" name="roll_no" required value="{{$data->roll_no}}">
						</div>
						<div class="col-sm-3">
							...
							<select class="form-control" name="select_class" id="select_class" required>
								...
								<option value="{{ $cleases->id }}" @if($data->class == $cleases->id) selected
									@endif>{{ $cleases->name }}</option>
								@endforeach
								<select>
						</div>
						<div class="col-sm-3">
							...
							<select class="form-control" name="section" id="sections">
								...
								<option value="{{$sec->id}}" @if($data->section==$sec->id) selected
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							...
							<select class="form-control" name="gender">
								...
								<option value="{{$genders->id}}" @if($data->gender == $genders->id) selected
									@endif>{{$genders->name}}</option>
								@endforeach
								<select>
						</div>
					...
					<div class="form-group row">
						<div class="col-sm-3">
							...
							<select class="form-control" name="category">
								...
								<option value="{{$cate->id}}" @if($data->category == $cate->id) selected
					...
					<div class="form-group row">
						<div class="col-sm-3">
							...
							<select class="form-control" name="blood_group">
								...
								<option value="{{$blood->id}}" @if($data->blood_group == $blood->id) selected
									@endif>{{$blood->group_name}}</option>
								@endforeach
							</select>
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							...
							<select class="form-control" name="group_id" required>
								...
								<option value="{{$group->id}}" @if($data->group_id == $group->id) selected
						...
						<div class="col-sm-3">
							...
							<input type="file" name="stu_pic" id="input-file-now" class="form-control dropify" size="20"
								...
								data-default-file="{{asset('public/uploads/student/'.$data->student_photo)}}" />
						</div>
						<div class="col-sm-3">
							<div class="row">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<h6 class="sibling_name bg-success text-white rounded"><b
											class="student_nam">{{ $data->sibling ? $data->sibling->first_name.' '.$data->sibling->last_name : 'N/A' }}</b>
									</h6>
								</div>
								<input type="hidden" class="sibling_id" name="sibling_id"
									value="{{ $data->sibling ? $data->sibling->id : '' }}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							...
							<input type="file" name="father_pic" id="input-file-now" class="form-control dropify"
								size="20" height="10px" autocomplete="off"
								data-default-file="{{asset('public/uploads/student/'.$data->father_photo)}}" />
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-3">
						...
						<div class="col-sm-3">
							...
							<input type="file" name="mother_pic" id="input-file-now" class="form-control dropify"
								size="20" height="10px" autocomplete="off"
								data-default-file="{{asset('public/uploads/student/'.$data->mother_photo)}}" />
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-12{{$errors->has('guardian_is')? ' has-error':''}}">
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input" name="guardian_is" type="radio" id="inlineCheckbox1"
									value="father" @if($data->if_guardian_is == 'father') checked @endif>
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input" name="guardian_is" type="radio" id="inlineCheckbox2"
									value="mother" @if($data->if_guardian_is == 'mother') checked @endif>
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input" name="guardian_is" type="radio" id="inlineCheckbox3"
									value="other" @if($data->if_guardian_is == 'other') checked @endif>
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							...
							<input type="file" name="guardian_pic" id="input-file-now" class="form-control dropify"
								size="20" height="10px" autocomplete="off"
								data-default-file="{{asset('public/uploads/student/'.$data->guardian_photo)}}" />
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-3">
							...
							<input type="text" class="form-control" id="guardian_phone" name="guardian_phone"
								value="{{$data->guardian_phone}}" required>
						</div>
						<div class="col-sm-3">
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel">
					<!--<div class="panel_header" role="tab" id="">
					      <h4 class="panel-title">
					        <a class="anchor-collaps collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="">
					          Add More Details
						...
						<div class="panel-body">
									...
									<div class="form-group row">
										<div class="col-sm-6">
											...
											<select class="form-control" name="route_id" id="route_id">
												...
												<option value="{{$route->id}}" @if($data->route_id==$route->id) selected
													@endif>{{$route->name}}</option>
												@endforeach
											</select>
										</div>
										<div class="col-sm-6">
											...
											<select class="form-control" name="bus_id" id="bus_id">
												<option value>Select</option>
												@foreach($bus as $buss)
												<option value="{{$buss->id}}" @if($data->vehicle_id == $buss->id)
													selected @endif>{{$buss->vehicle_number}}</option>
												@endforeach
											</select>
										</div>
									</div>
									  ...
									  <div class="form-group row">
									    <div class="col-sm-6">
									        ...
									        <select class="form-control" name="hostel_id" id="hostel_id">
									        	...
									        	<option value="{{$hos->id}}" @if($data->hostel_id==$hos->id) selected @endif>{{$hos->hostel_name}}
								</option>
								@endforeach
								</select>
							</div>
							<div class="col-sm-6">
								...
								<select class="form-control" name="rooom_number" id="rooom_number">
									<option value="">Select</option>
									@foreach($room as $roomnumber)
									<option value="{{$roomnumber->id}}" @if($data->room_num == $roomnumber->id) selected
										@endif>{{$roomnumber->room_number}}</option>
									@endforeach
								</select>
							</div>
						</div>
						...
						<div class="form-group row">
							<div class="col-sm-6">
								...
								<textarea class="form-control"
									name="previous_school_detail">{{$data->previous_school_detail}}</textarea>
							</div>
							<div class="col-sm-6">
								<label for="inputEmail3" class="text-left">Note</label>
								<textarea class="form-control"
									name="previous_school_note">{{$data->previous_school_note}}</textarea>
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								...
								<input type="text" name="docu_title1" class="form-control"
									value="{{$data->	docu_title1}}">
							</div>
							<div class="col-sm-5">
								<label for="inputEmail3" class="text-left">Document</label>
								<input type="file" name="docu_1" id="input-file-now" class="form-control dropify"
									size="20" height="10px" autocomplete="off"
									data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_1)}}" />
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								...
								<input type="text" name="docu_title2" class="form-control"
									value="{{$data->docu_title2}}">
							</div>
							<div class="col-sm-5">
								<label for="inputEmail3" class="text-left">Document</label>
								<input type="file" name="docu_2" id="input-file-now" class="form-control dropify"
									size="20" height="10px" autocomplete="off"
									data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_2)}}" />
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								...
								<input type="text" name="docu_title3" class="form-control"
									value="{{$data->docu_title3}}">
							</div>
							<div class="col-sm-5">
								<label for="inputEmail3" class="text-left">Document</label>
								<input type="file" name="docu_3" id="input-file-now" class="form-control dropify"
									size="20" height="10px" autocomplete="off"
									data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_3)}}" />
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								...
								<input type="text" name="docu_title4" class="form-control"
									value="{{$data->docu_title4}}">
							</div>
							<div class="col-sm-5">
								<label for="inputEmail3" class="text-left">Document</label>
								<input type="file" name="docu_4" id="input-file-now" class="form-control dropify"
									size="20" height="10px" autocomplete="off"
									data-default-file="{{asset('storage/public/uploads/student/file/'.$data->docu_4)}}" />
							</div>
			...
			<div class="modal-body">
				<form id="add_sibling_form" action="" method="get">
					...
					<div class="form-group row">
						...
						<select id="students" class="select2 select_student col-md-8"
							data-dropdown-css-class="select2-purple" style="width: 67%;">
